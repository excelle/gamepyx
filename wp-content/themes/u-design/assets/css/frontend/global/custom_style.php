...
.has-small-font-size { font-size: <?php echo ( $udesign_options['general_font_size'] - 2 ); ?>px; }
.has-normal-font-size { font-size: <?php echo $udesign_options['general_font_size']; ?>px; }
.has-medium-font-size  { font-size: <?php echo ( $udesign_options['general_font_size'] + 4 ); ?>px; }
.has-large-font-size  { font-size: <?php echo ( $udesign_options['general_font_size'] + 20  ); ?>px; }
.has-larger-font-size  { font-size: <?php echo ( $udesign_options['general_font_size'] + 34 ); ?>px; }
...
<?php if ( isset( $udesign_options['feedback_button_color'] ) && $udesign_options['feedback_button_color'] ) : ?>
	#feedback a.feedback { background-color: #<?php echo $udesign_options['feedback_button_color']; ?>; }
<?php endif; ?>
...
<?php if ( isset( $udesign_options['submenu_arrows'] ) && $udesign_options['submenu_arrows'] !== 'none' ) : ?>
	...
	?>
	<?php echo $udesign_fa_body_tag_class; ?> #navigation-menu .sf-arrows .sf-with-ul:after,
	<?php echo $udesign_fa_body_tag_class; ?> #navigation-menu .sf-arrows .top_bg_color .sf-with-ul:after {
		content: "<?php echo $arrow_down; ?>";
		position: absolute;
		right: <?php echo $arrow_pos_right; ?>px;
		top: 50%;
		margin-top: -<?php echo $arrow_margin_top; ?>px;
		padding: 0;
		font-size: <?php echo $arrow_font_size; ?>px;
		font-family: fontawesome;
		font-style: normal;
		font-weight: 400;
		box-sizing: border-box;
		color:#<?php echo $udesign_options['top_nav_link_color']; ?>;
	}
	<?php echo $udesign_fa_body_tag_class; ?> #navigation-menu .sf-arrows ul.sub-menu .sf-with-ul:after {
		content: "<?php echo $arrow_right; ?>";
		top: 14px;
		margin-top: -7px;
		margin-left: 0;
		color:#<?php echo $udesign_options['dropdown_nav_link_color']; ?>;
	}
	<?php echo $udesign_fa_body_tag_class; ?> #navigation-menu .sf-arrows ul.sub-menu .sf-with-ul:hover:after {
		color:#<?php echo $udesign_options['dropdown_nav_hover_link_color']; ?>;
	}
<?php endif; ?>
...
@media screen and (min-width: <?php echo ( $udesign_options['global_theme_width'] + 140 ); ?>px) {
	.udesign-is-global-page-width #main-content .alignwide {
		margin-left: -70px;
		margin-right: -70px;
		max-width: <?php echo ( $udesign_options['global_theme_width'] + 100 ); ?>px;
	}
	.udesign-is-global-page-width #main-content .wp-block-table.alignwide,
	.udesign-is-global-page-width #main-content .wp-block-cover.alignwide,
	.udesign-is-global-page-width #main-content .wp-block-pullquote.alignwide {
		width: <?php echo ( $udesign_options['global_theme_width'] + 100 ); ?>px;
	}
}
<?php
