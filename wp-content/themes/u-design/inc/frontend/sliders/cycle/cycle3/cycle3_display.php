...
<?php                                   // The slide link (if any)
                                        if ( $c3_slide_link_url ) : ?>
                                            <div class="c3_slide_link_url">
                                                <a target="_<?php echo $c3_slide_link_target; ?>" href="<?php echo $c3_slide_link_url; ?>" title=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/spacer.gif" alt="spacer" width="940" height="430" /></a>
                                            </div>
<?php                                   endif; ?>
