...
add_action( 'save_post',         'udesign_get_the_image_delete_cache_by_post'        );
add_action( 'deleted_post_meta', 'udesign_get_the_image_delete_cache_by_meta', 10, 2 );
add_action( 'updated_post_meta', 'udesign_get_the_image_delete_cache_by_meta', 10, 2 );
add_action( 'added_post_meta',   'udesign_get_the_image_delete_cache_by_meta', 10, 2 );
 ...
 */
function udesign_get_the_image( $args = array() ) {

	$image = new UDesign_Get_The_Image( $args );
 ...
 * @access private
 */
final class UDesign_Get_The_Image {
 ...
 * @return void
 */
function udesign_get_the_image_delete_cache_by_post( $post_id ) {
 ...
 * @return void
 */
function udesign_get_the_image_delete_cache_by_meta( $meta_id, $post_id ) {
	wp_cache_delete( $post_id, 'get_the_image' );
}
