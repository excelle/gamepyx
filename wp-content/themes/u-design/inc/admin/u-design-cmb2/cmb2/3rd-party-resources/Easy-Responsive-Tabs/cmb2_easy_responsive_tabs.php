...
class Easy_Responsive_Tabs {
	...
	public function ert_setup_admin_scripts() {
		wp_enqueue_style( 'easy-responsive-tabs', get_template_directory_uri() . '/inc/admin/u-design-cmb2/cmb2/3rd-party-resources/Easy-Responsive-Tabs/css/easy-responsive-tabs.css', array('cmb2-styles'), self::VERSION );
		wp_enqueue_script( 'easy-responsive-tabs-js', get_template_directory_uri() . '/inc/admin/u-design-cmb2/cmb2/3rd-party-resources/Easy-Responsive-Tabs/js/easyResponsiveTabs.min.js', array( 'jquery' ), self::VERSION, true );
	}
