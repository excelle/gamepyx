...
class UDesign_Theme_Options {
	...
	function on_load_page() {
		...
		wp_enqueue_style('style', get_template_directory_uri().'/assets/css/admin/style.css', false, '1.0', 'screen');
                wp_enqueue_media();
		...
		// load tablednd scripts for all sliders except Revolution slider
                if ( $udesign_options['current_slider'] != 8) {
                    ...
                    wp_register_script('sliders-scripts', get_template_directory_uri().'/assets/js/admin/sliders.scripts.js', array('jquery','tablednd'), '1.0', true);
                    wp_enqueue_script('sliders-scripts');
                }
		//load color picker scripts
		wp_enqueue_style('ud-colorpicker-style', get_template_directory_uri().'/inc/admin/colorpicker/css/colorpicker.css', false, '1.0', 'screen');
...
<?php	}
	...
	function help_options_contentbox( $options ) { ?>
		...
		<ul style="list-style-type:none; margin:5px 5px 10px 20px;">
			<li><?php echo '<div><a href="'.get_template_directory_uri().'/inc/shared/documentation/index.html" title="'.esc_html__('Open the documentation', 'udesign').'" target="_blank">'.esc_html__('Documentation', 'udesign').'</a></div>'; ?></li>
			...
			<tr valign="top">
			    ...
			    <td>
				    ...
				    <!-- Feedback button text field. -->
                                    <label for="feedback_btn_text"><?php esc_html_e( 'Button Text:', 'udesign' ); ?></label>
				    <input name="udesign_options[feedback_btn_text]" type="text" id="feedback_btn_text" value="<?php echo ( $options['feedback_btn_text'] ) ? esc_attr( $options['feedback_btn_text'], 'udesign' ) : 'feedback'; ?>" size="20" maxlength="100" />
				    <br />
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<div id="feedbackButtonColor">
				    <div style="background-color: #<?php echo ($options['feedback_button_color']) ? esc_attr($options['feedback_button_color']) : 'FD7800'; ?>;"></div>
				</div>
			    </td>
			    <td>
				<input name="udesign_options[feedback_button_color]" id="feedback_button_color" type="text" maxlength="6" size="7" style="margin:2px 10px 0 0" value="<?php echo ($options['feedback_button_color']) ? esc_attr($options['feedback_button_color']) : 'FD7800'; ?>" />
				<?php esc_html_e("Button color.", 'udesign'); ?>
			    </td>
			</tr>
		    </tbody>
		</table>
	...
	function menus_options_contentbox( $options ) { ?>
			...
			<tr valign="top">
				...
				<span> px. <?php esc_html_e('This option allows you to move the menu vertically towards the top or bottom of the Top Area ("0" is the default which places the menu at the bottom).', 'udesign'); ?></span>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e('Submenu Indicator Arrows', 'udesign'); ?></th>
                            <td>
                                <?php esc_html_e('Choose arrow style:', 'udesign'); ?>
                                <select name="udesign_options[submenu_arrows]" id="submenu_arrows">
                                    <option value="none"<?php echo ($options['submenu_arrows'] === 'none') ? ' selected="selected"' : ''; ?> style="padding-right:10px;"><?php esc_attr_e('None', 'udesign'); ?></option>
                                    <option value="plus-sign"<?php echo ($options['submenu_arrows'] === 'plus-sign') ? ' selected="selected"' : ''; ?>><?php esc_attr_e('Plus Sign', 'udesign'); ?></option>
                                    <option value="angle-down"<?php echo ($options['submenu_arrows'] === 'angle-down') ? ' selected="selected"' : ''; ?>><?php esc_attr_e('Angle Down', 'udesign'); ?></option>
                                    <option value="angle-double-down"<?php echo ($options['submenu_arrows'] === 'angle-double-down') ? ' selected="selected"' : ''; ?>><?php esc_attr_e('Angle Double Down', 'udesign'); ?></option>
                                    <option value="downwards-arrow"<?php echo ($options['submenu_arrows'] === 'downwards-arrow') ? ' selected="selected"' : ''; ?>><?php esc_attr_e('Downwards Arrow', 'udesign'); ?></option>
                                    <option value="caret"<?php echo ($options['submenu_arrows'] === 'caret') ? ' selected="selected"' : ''; ?>><?php esc_attr_e('Caret', 'udesign'); ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr valign="top">
		...
		<table class="form-table">
			...
			<tr valign="top">
                ...
                <div style="margin:10px 0; padding:15px 15px 20px; display:block; background-color:#F8F8F1; border:1px solid #DDD;">
                  <h2 style="color:#ff4d00; margin: 2px 0; padding:0;"><?php esc_html_e('Custom Page Width', 'udesign'); ?></h2>
                  <p><span class="description"><?php esc_html_e("This section allows you to set the page and sidebar width globally.", 'udesign'); ?></span></p>
		  <table class="form-table">
		    <tbody>
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Fluid Layout', 'udesign'); ?></th>
			    <td>
				<fieldset><legend class="screen-reader-text"><span><?php esc_html_e('Fluid Layout', 'udesign'); ?></span></legend>
			...
			<tr valign="top" id="global_theme_width_slide_bar_wrapper">
			    <th scope="row" style="padding-right:0"><?php esc_html_e('Page Width', 'udesign'); ?></th>
			    <td>
			...
			<tr valign="top">
			    <th scope="row" style="padding-right:0"><?php esc_html_e('Sidebar Width', 'udesign'); ?></th>
			    <td>
			...
			<tr valign="top">
			    <th scope="row" style="padding-right:0"><?php esc_html_e('Content Width', 'udesign'); ?></th>
			    <td>
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<label for="general_font_line_height" style="float:left; margin-right:7px; line-height:2;"><?php esc_html_e('Line Height: ', 'udesign'); ?></label>
                                <input name="udesign_options[general_font_line_height]" type="text" id="general_font_line_height" value="<?php echo ($options['general_font_line_height']) ? esc_attr($options['general_font_line_height']) : '1.8'; ?>" size="5" maxlength="4" />
                                <?php esc_html_e('This option can be used to specify the line height for the general body text. Range from 0.2 to 5.0 (default: 1.8)', 'udesign'); ?>
			    </td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<label for="headings_font_line_height" style="float:left; margin-right:7px; line-height:2;"><?php esc_html_e('Line Height: ', 'udesign'); ?></label>
                                <input name="udesign_options[headings_font_line_height]" type="text" id="headings_font_line_height" value="<?php echo ($options['headings_font_line_height']) ? esc_attr($options['headings_font_line_height']) : '1.3'; ?>" size="5" maxlength="4" />
                                <?php esc_html_e('This option can be used to specify the line height for the headings. Range from 0.2 to 5.0 (default: 1.3)', 'udesign'); ?>
				...
				<label for="heading1_font_line_height" style="float:left; margin-right:7px; line-height:2;"><?php esc_html_e('Line Height: ', 'udesign'); ?></label>
                                ...
                                &nbsp;&nbsp;<span class="description"><?php esc_html_e('(min: 0.2, max: 5.0, default: 1.3)', 'udesign'); ?></span>
			    </td>
			</tr>
...
<?php                                           endforeach; ?>
                                            ...
                                            <span class="description"><?php  printf( __('For help please refer to the %1$sDocumentation%2$s.', 'udesign'), '<a title="'.esc_html__('Go to the Documentation', 'udesign').'" target="_blank" href="'.get_template_directory_uri().'/inc/shared/documentation/index.html#revslider-description">', '</a>' ); ?></span>
                                            <div class="clear"></div>
<?php                                   endif; ?>
                                    </td>
                                </tr>
...
<?php	}
	...
	function contact_page_options_contentbox( $options ) {
		...
		$email_receipients = $options['email_receipients']; ?>
                ...
                <h4 class="u-design-settings-page-headers"><?php esc_html_e('Contact Information', 'udesign'); ?></h4>
...
<?php		display_save_changes_button(); ?>
                ...
                <h4 class="u-design-settings-page-headers"><?php esc_html_e('reCAPTCHA (v2)', 'udesign'); ?></h4>
		<table class="form-table">
		    <tbody>
			<tr valign="top">
                ...
                <div style="margin:10px 0; padding:15px 15px 20px; display:block; background-color:#FCFCFC; border:1px solid #DDD;">
                  <h2 style="color:#ff4d00; margin: 2px 0; padding:0;"><?php esc_html_e('reCAPTCHA API keys', 'udesign'); ?></h2>
		  <table class="form-table">
		    <tbody>
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Site Key', 'udesign'); ?></th>
			    <td>
			...
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Secret Key', 'udesign'); ?></th>
			    <td>
		...
		<table class="form-table">
		    <tbody>
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Language', 'udesign'); ?></th>
			    <td>
...
<?php		display_save_changes_button(); ?>
                ...
                <h4 class="u-design-settings-page-headers"><?php esc_html_e('Data Collection, Privacy and GDPR', 'udesign'); ?></h4>
		<table class="form-table">
		    <tbody>
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Data Collection and Privacy', 'udesign'); ?></th>
			    <td>
				<fieldset><legend class="screen-reader-text"><span><?php esc_html_e('Data Collection and Privacy', 'udesign'); ?></span></legend>
				<label for="data_collection_message_on">
				    ...
				    <?php esc_html_e( 'Enable Data Collection and Privacy Message.', 'udesign' ); ?>
				</label><br />
				<span class="description"><?php esc_html_e('Enable Data Collection and Privacy Message', 'udesign'); ?></span>
				</fieldset>
			    </td>
			</tr>
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Data Collection and Privacy Text', 'udesign'); ?></th>
			    <td>
				<textarea style="width: 98%;" id="data_collection_message" rows="2" cols="60" name="udesign_options[data_collection_message]"><?php echo ( $options['data_collection_message'] ) ? esc_attr( $options['data_collection_message'] ) : data_collection_message_default_text(); ?></textarea>
				<br />
				<span class="description"><?php esc_html_e( "The content provided in the above field will be displayed immediately above the consent checkbox to tell users which personal data you want to collect and have a link to your privacy policy page, something required for GDPR compliance.", 'udesign'); ?></span>
                                <span class="description"><?php echo sprintf( esc_html__( "You may create or select your site's privacy policy page under %sSettings &rarr; Privacy%s.", 'udesign'), '<strong>', '</strong>' ); ?></span>
			    </td>
			</tr>
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Consent Checkbox', 'udesign'); ?></th>
			    <td>
				<fieldset><legend class="screen-reader-text"><span><?php esc_html_e('Consent Checkbox', 'udesign'); ?></span></legend>
				<label for="contact_consent_on">
				    ...
				    <?php esc_html_e( 'Enable the user consent option.', 'udesign' ); ?>
				</label>
				</fieldset>
			    </td>
			</tr>
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Consent Checkbox Text', 'udesign'); ?></th>
			    <td>
				<input name="udesign_options[contact_consent_text]" type="text" id="contact_consent_text" value="<?php echo ( $options['contact_consent_text'] ) ? esc_attr( $options['contact_consent_text'] ) : contact_consent_default_text(); ?>" size="100" maxlength="1000" />
			    </td>
			</tr>
		    </tbody>
		</table>
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<span class="description"><?php esc_html_e('Copyright message displayed in the footer.', 'udesign'); ?></span>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php esc_html_e('"Back to Top" link', 'udesign'); ?></th>
                            <td>
                                <?php esc_html_e('Choose style:', 'udesign'); ?>
                                <select name="udesign_options[back_to_top]" id="back_to_top">
                                    <option value="angle-up"<?php echo ($options['back_to_top'] === 'angle-up') ? ' selected="selected"' : ''; ?>><?php esc_attr_e('Angle-Up Icon (fixed on scroll)', 'udesign'); ?></option>
                                    <option value="text"<?php echo ($options['back_to_top'] === 'text') ? ' selected="selected"' : ''; ?>><?php esc_attr_e('"Back to Top" Text', 'udesign'); ?></option>
                                    <option value="none"<?php echo ($options['back_to_top'] === 'none') ? ' selected="selected"' : ''; ?> style="padding-right:10px;"><?php esc_attr_e('None', 'udesign'); ?></option>
                                </select>
                            </td>
                        </tr>
			<tr valign="top">
			    <th scope="row"><?php printf( esc_html__('%s credits link', 'udesign'), $wordpress_or_classicpress ); ?></th>
			    <td>
				<fieldset><legend class="screen-reader-text"><span><?php printf( esc_html__('%s credits link', 'udesign'), $wordpress_or_classicpress ); ?></span></legend>
				<label for="show_wp_link_in_footer">
				    ...
				    <?php printf( esc_html__('Show "is proudly powered by %s" in footer?', 'udesign'), '<strong>' . $wordpress_or_classicpress . '</strong>' ); ?>
				</label>
				</fieldset>
			    </td>
			</tr>
...
function data_collection_message_default_text() {
    return sprintf( esc_html__('This form collects your name, email and phone number so that we can correspond with you. Check out our %1$sprivacy policy%2$s for the full story on how we protect and manage your submitted data!', 'udesign'), '<a href="'.esc_url( trailingslashit( is_multisite() ? network_site_url() : site_url() ) . 'privacy-policy/' ).'">', '</a>' );
}

function contact_consent_default_text() {
    return sprintf( esc_html__( 'I consent to having %s collect my name, email and phone number!', 'udesign' ), '<em>'.get_option( 'blogname' ).'</em>' );
}
