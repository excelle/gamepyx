...
function load_udesign_icon_fonts_page_scripts () {
    ...
    wp_enqueue_style('udesign-icon-fonts', get_template_directory_uri().'/inc/shared/icon-fonts/icon-fonts-page-styles.css', false, '1.0', 'screen');
    // Enqueue the WP Media uploader
    wp_enqueue_media();
    wp_register_script('udesign-icon-fonts', get_template_directory_uri().'/inc/shared/icon-fonts/icon-fonts-scripts.js', array('jquery'), '1.0', true);
...
<?php       elseif ( $tab == 'font_awesome' ) : ?>
                ...
                <a href="<?php echo get_template_directory_uri(); ?>/inc/shared/documentation/index.html#icon-fonts" title="Open the documentation" target="_blank"><?php esc_html_e('Icon Fonts Documentation', 'udesign'); ?></a>
                <p>
...
<?php               printf( esc_html__('For your reference a full list of all the FA icons can be found at %s', 'udesign'), 
                ...
                <p style="padding: 5px 0 0 140px;">
                    <a target="_blank" href="http://fortawesome.github.io/Font-Awesome/icons/" title="The Icons List"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/the-fa-icons-list.png" alt="the icons list" /></a>
                </p>
...
<?php               printf( esc_html__('Here\'s some example uses from the Font Awesome website: %s', 'udesign'), 
                ...
                <p style="padding: 5px 0 30px 140px;">
                    <a target="_blank" href="http://fortawesome.github.io/Font-Awesome/examples/" title="Font-Awesome Examples"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/fa-examples.png" alt="fa examples" /></a>
                </p>
...
<?php               esc_html_e('I have also provided a button in each post/page editor to insert icons in your content directly. This option will allow you to select, style and generate your code:', 'udesign'); ?>
                ...
                <p style="padding: 10px 0 0 40px;">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/add-icon-button.png" alt="select-icon-popup image" />
                </p>
...
if ( ! $udesign_font_awesome_options['udesign_disable_font_awesome'] || udesign_is_fontello_installed() ) {
	...
	/* ONLY LOAD THE BELOW STYLES AND SCRIPTS ON ADMIN PAGES WITH EDITOR 
	   'admin-ajax.php' check is for VC editor */
	global $pagenow;
	if ( in_array( $pagenow, array( 'post.php', 'post-new.php', 'admin-ajax.php' ), true  ) ) {
		...
		function udesign_load_icon_fonts_wp_admin_scripts() {
			...
			wp_enqueue_style( 'u-design-icon-fonts-editor-popup', get_template_directory_uri().'/inc/shared/icon-fonts/icon-fonts-editor-popup-styles.css', false, UDESIGN_VERSION, 'screen' );
		...
		// Load the fontello style sheets for the editor so the icons' styles could be rendered.
		if ( udesign_is_fontello_installed() ) {
		...
		include( trailingslashit( get_template_directory() ) . 'inc/shared/icon-fonts/icon-fonts-tc-editor-button.php' );
